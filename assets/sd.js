  ...
  $(document).ready(function () {
    ...
    if ($headerPdp.length) {
      $(window).scroll(function (event) {
        const $atcOffset =
          $productForm.offset().top + $productForm.outerHeight(true);
...
solodrop.Sections = function Sections() {
  this.constructors = {};
  this.instances = [];
...
solodrop.Variants = (function () {
  ...
  Variants.prototype = $.extend({}, Variants.prototype, {
    ...
    _updateImages: function (variant) {
      ...
      var currentVariantImage = this.currentVariant.featured_media || {};
      var variantImageId = '';
      ...
      if (
        ...
        variant.featured_media !== undefined ||
      ...
      const $variantImages = $(
        '.product__image [data-image-id="' + variantImageId + '"]',
      );

      $variantImages.each(function () {
        const $variantImage = $(this);

        if (!$variantImage.length) return;

        //TODO: the slider below is not accounting for mobile or desktop. it's just selecting the first occuring

        const variantImageIndex = parseInt($variantImage.attr('data-index'));
        const sliders = document.querySelectorAll('image-slider');

        for (let slider of sliders) {
          let swiperSlider = slider?.swiper;
          const sliderControls = slider.querySelectorAll('.js-slider-control');
...
theme.Product = (function () {
  ...
  Product.prototype = $.extend({}, Product.prototype, {
    ...
    updateProductImage: function (evt) {
      var variant = evt.variant;
      var sizedImgUrl = solodrop.Image.getSizedImageUrl(
...
$(document).ready(function () {
  ...
  const isRandom =
    $salesPopData.attr('data-selection') == 'random' ? true : false;
  ...
  if (solodrop.cart.cookiesEnabled()) {
  ...
  const searchResultsContainer = document.querySelector('predictive-search');
  const searchInput = searchResultsContainer.querySelector('.search-input');
